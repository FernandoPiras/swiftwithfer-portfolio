...
- Nome azienda / Brand commerciale
- Ragione sociale
- Nome e cognome referente
- Telefono
- Email
- Obiettivi principali del progetto (cosa deve ottenere l'azienda)
- Problemi attuali da risolvere (pain points)
- Priorità (ordinare: Must-have, Should-have, Nice-to-have)
- Target / Buyer Personas (età, professione, esigenze, comportamenti)
- Descrizione completa dell'attività
- Customer journey (dalla scoperta al post-vendita)
- Ruoli utente previsti (descrizione e permessi)
- Dettaglio funzionalità custom (descrizione approfondita per ciascuna)
- Flussi di pagamento dettagliati (quando, quanto, rimborsi)
- User flow principali (descrivi i percorsi utente chiave)
- Entità principali (es. Utente, Prodotto, Ordine, Appuntamento)
- Milestone chiave con date target
